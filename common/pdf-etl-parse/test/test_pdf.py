...
def test_pdfid():
    doc = json.loads(r'''{ "_id" : "5dc351a60923be6f86000005", "invoker" : { "exec" : "python", "invName": "pdfid", "preArgs" : [ "../lib/pdfid_v0_2_7/pdfid.py", "-e" ], "postArgs" : [ ], "timeoutScale" : 18, "version" : "pdfid_v0_2_7", "_cons" : "Invoker" }, "file" : "../test/data/000009.pdf", "result" : { "exitcode" : 0, "timeElapsed" : 1, "stdoutRes" : "PDFiD 0.2.5 ../test/data/000009.pdf\n PDF Header: %PDF-1.4\n obj                   64\n endobj                64\n stream                19\n endstream             19\n xref                   2\n trailer                2\n startxref              2\n /Page                  4\n /Encrypt               0\n /ObjStm                0\n /JS                    0\n /JavaScript            0\n /AA                    0\n /OpenAction            1\n /AcroForm              0\n /JBIG2Decode           0\n /RichMedia             0\n /Launch                1\n /EmbeddedFile          0\n /XFA                   0\n /URI                   0\n /Colors > 2^24         0\n %%EOF                  2\n After last %%EOF       0\n D:20020425141417-03'00  /ModDate\n Total entropy:           7.688588 (     39586 bytes)\n Entropy inside streams:  7.978351 (     30298 bytes)\n Entropy outside streams: 4.970143 (      9288 bytes)\n\n", "stderrRes" : "", "_cons" : "GoodResult" }, "_cons" : "Invocation" }''')
