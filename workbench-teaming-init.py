...
machine. A deployment may be bootstrapped as follows:
    ...
    python workbench-teaming-init.py [--port 8123] [--port-mongo 9123] [--port-dask 8786] [--port-dask-worker 8787] build/pdf-dist-2021-02-10 team/pdf-dist-2021-02-10 web-host /path/to/files/on/web-host [worker1 worker2 ...]
...
def main():
    ...
    ap.add_argument('--port-dask-worker', default=8787, type=int,
